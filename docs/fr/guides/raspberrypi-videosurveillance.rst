...
Puis installer **docker** et **docker-compose** :
...
..  code-block:: shell
    ...
    fqdn: motionui.example.com (à remplacer par le nom de domaine dédié à motion-UI, ou bien un nom d'hôte local si vous n'avez pas de nom de domaine)
